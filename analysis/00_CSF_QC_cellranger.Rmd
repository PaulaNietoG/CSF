...
root_dir <- ifelse(
  ...
  "/scratch/devel/pnieto/projects/", #tre statement
  "S:/projects/" # false statement
)
# name of the project directory
proj_dir <- glue::glue("{root_dir}PLEURA/")
...
```{r}
# get subprojects in cluster data path
subprojects <- list.dirs(
  path = data_dir, 
  full.names = FALSE, 
  recursive = FALSE
  ) %>% 
  grep(pattern = "^SCGRES|DOCT", value = TRUE)
```
