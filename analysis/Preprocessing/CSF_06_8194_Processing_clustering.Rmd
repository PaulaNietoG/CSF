...
data <- CellSelector(plot = DimPlot(data), object = data, ident = 9)
...
```{r eval = FALSE}
Idents(data) <- "seurat_clusters"
new.cluster.ids <- c("T cells", "T cells", "Myeloid cells", "B cells", "Myeloid cells", "bad", "T cells", "pDC", "DC", "Prolif", "B cells")
