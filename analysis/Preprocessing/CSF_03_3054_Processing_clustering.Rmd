...
```{r eval = FALSE}
Idents(data) <- "seurat_clusters"
new.cluster.ids <- c("B cells", "T cells", "T cells", "T cells", "T cells", "B cells", "B cells", "T cells", "Myeloid", "T cells", "DC", "T cells", "DC", "pDC")
names(new.cluster.ids) <- c(0:13)
