...
```{r eval = FALSE}
Idents(data) <- "seurat_clusters"
new.cluster.ids <- c("T cells", "Myeloid", "B cells", "T cells", "T cells", "Plasma/Tumor cells", "T cells", "Proliferative")
...
FeaturePlot(
  data,
  features = c("IGHM", "MS4A1", "CD79A", "CD79B", "MYD88", "SMAD4"),
  cols = c("#ADD8E633", "#E46726"),
  order = TRUE,
  label = TRUE,
  label.size = 3,
...
DotPlot(data,
        group.by = "annot_2",
        features = c("MYD88", "IGHM", "CD89A", "MS4A1"),
        ) +
  RotatedAxis() +
  scale_color_gradient2(low = 'blue', mid = 'white', high = 'red')
```
