...
```{r eval = FALSE}
Idents(data) <- "seurat_clusters"
new.cluster.ids <- c("T cells", "T cells - NK", "Proliferative", "Myeloid", "Macrophages", "T cells", "pDC", "T cells", "DC", "B cells")
names(new.cluster.ids) <- c(0:9)
