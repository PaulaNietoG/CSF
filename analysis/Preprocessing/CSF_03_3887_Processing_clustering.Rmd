...
t1 <- table(!is.na(subset(data, annot == "Plasma B cells")$cloneType)) %>% as.data.frame()
colnames(t1) <- c("BCRs", "# Cells")

t2 <- round((table(!is.na(subset(data, annot == "Plasma B cells")$cloneType))/dim(subset(data, annot == "Plasma B cells"))[2])*100,2) %>% as.data.frame()
