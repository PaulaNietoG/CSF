...
```{r eval = FALSE}
Idents(data) <- "seurat_clusters"
new.cluster.ids <- c("Monocytes", "Melanoma tumor cells", "T cells", "Macrophages", "Monocytes", "Monocytes", "DC", "Tumor cells", "Plasma B cells")
names(new.cluster.ids) <- c(0:8)
